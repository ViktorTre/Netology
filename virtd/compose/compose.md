...
# Домашнее задание к занятию 4 «Оркестрация группой Docker контейнеров на примере Docker Compose» - Третьяков Виктор
...
не было активных процессов, поэтому остановился контейнер
...
Контейнер прокидывает 80 порт на 8080 , а nginx слушает 81 порт, поэтому получился логический разрыв
