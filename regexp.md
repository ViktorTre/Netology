...
Используя `awk` и `ps aux` соберите информацию о:
 ...
 ![](/images/awk/awk1.png "1 скрин 3 задания")
 ![](/images/awk/awk2.png "2 скрин 3 задания")
 - процессе с самым большим PID;\
 ![](/images/awk/awk3.png "3 скрин 3 задания")
 ![](/images/awk/awk4.png "4 скрин 3 задания")
 - (дополнительное задание со звездочкой*) суммарном использовании памяти различными пользователями.\
  ![](/images/awk/awk5.png "5 скрин 3 задания")
